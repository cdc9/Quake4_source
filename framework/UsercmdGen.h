...
const int IMPULSE_23			= 23;			// Level up 1 button mod
const int IMPULSE_24			= 24;			// Level up 2 button mod
const int IMPULSE_25			= 25;			// Level up 3 button mod
const int IMPULSE_26			= 26;			// Level up 4 button mod
const int IMPULSE_27			= 27;			// instakill mod
